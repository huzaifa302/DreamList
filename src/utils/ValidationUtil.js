...
export const ValidationSchema = {
  ...
  PersonalInformation: yup.object().shape({
    name: Validation.required('name'),
    userName: Validation.alphanumeric('User Name'),
    country: Validation.required('Country'),
    city: Validation.required('City'),
    dateOfBirth: Validation.required('Date Of Birth'),
    preferredGenre: Validation.required('Preferred Genre'),
    bio: Validation.required('Bio')
  })
};
